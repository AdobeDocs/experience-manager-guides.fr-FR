...
### Générer une sortie basée sur des articles à partir de l’éditeur web
...
1. Sélectionnez le paramètre prédéfini de sortie **Site**.
...
![Rechercher une sortie AEM Sites](images/aem-output-search.png){width="650"}
