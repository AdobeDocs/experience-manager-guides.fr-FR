   ...
   - Gérer le contenu de formation {#learning-training-content}
      - Guide de prise en main {#get-started}
         - Présentation {#intro-lc}
            - [Notes de mise à jour](./release-info-lt/release-notes-lt-2025-12-v2.md)
            - [Notes de mise à jour](./release-info-lt/release-notes-lt-2026-02-v3.md)
...
- Installation et configuration {#install-guide}
   - On-Premise {#on-prem-ig}
      ...
      - Utiliser les paramètres de génération de sortie {#output-gen-config}
         ...
         - [Téléchargement et installation de modèles AEM Sites](./install-guide/download-install-aem-sites-templates.md)
         - [Mappage des composants pour AEM Sites](./install-guide/component-mapping.md)
   ...
   - Services cloud {#cs-ig}
      ...
      - Utiliser les paramètres de génération de sortie {#output-gen-config-cs}
         ...
         - [Téléchargement et installation de modèles AEM Sites](./cs-install-guide/download-install-aem-sites-templates-cs.md)
         - [Mappage des composants pour AEM Sites](./cs-install-guide/component-mapping.md)
...
- Installation et configuration {#install-conf-guide}
   ...
   - Configuration des paramètres de Workspace {#workspace-configs}
      - [Paramètres Workspace](./install-conf-guide/workspace-settings.md)
