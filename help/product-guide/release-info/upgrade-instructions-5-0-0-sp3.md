---
title: Notes de mise à jour | Instructions de mise à niveau vers Adobe Experience Manager Guides 5.0.0 Service Pack 3
description: Découvrez la matrice de compatibilité et comment effectuer une mise à niveau vers la version 5.0.0 Service Pack 3 d’Adobe Experience Manager Guides.
...
# Instructions de mise à niveau vers la version 5.0.0 du pack de services 3 (février 2026)

Cet article contient les instructions de mise à niveau et la matrice de compatibilité pour la version 5.0.0 du Service Pack 3 d’Adobe Experience Manager Guides.

Pour obtenir la liste des problèmes qui ont été résolus dans cette version, voir [Problèmes résolus dans le pack de services 3 d’ 5.0.0](../release-info/fixed-issues-5-0-0-sp3.md).

## Matrice de compatibilité

Cette section répertorie la matrice de compatibilité pour les applications logicielles prises en charge par Experience Manager Guides 5.0.0 Service Pack 3.
...
| Version | FMPS | FM |
| --- | --- | --- |
| 5.0.0 Service Pack 3 (UUID) | Pris en charge | 2022 ou version ultérieure |
...
## Mise à niveau vers la version 5.0.0 Service Pack 3 de Experience Manager Guides

Vous pouvez facilement mettre à niveau votre version actuelle de Guides vers la version 5.0.0 du Service Pack 3. Avant de procéder à la mise à niveau vers le pack de services 3 d’vers la version 5.0.0 de Experience Manager Guides, vous devez tenir compte des points suivants :

- Si vous utilisez la version 5.0.0 Service Pack 2, 5.0.0 Service Pack 1 ou 5.0.0, vous pouvez directement mettre à niveau vers la version 5.0.0 Service Pack 3.
