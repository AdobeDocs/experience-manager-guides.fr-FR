...
* La requête native PDF | `conkeyref` n’est pas résolue dans la sortie PDF générée. (10564)
* Native PDF | Des problèmes se produisent lors de l’accès aux métadonnées d’une carte dans la sortie PDF. (10556)
* Les styles PDF | Inline natifs sont utilisés pour générer des balises au lieu du nom de classe.  (10498)
