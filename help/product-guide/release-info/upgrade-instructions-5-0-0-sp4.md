---
title: Notes de mise à jour | Instructions de mise à niveau pour Adobe Experience Manager Guides 5.0.0 Service Pack 4
description: Découvrez la matrice de compatibilité et comment effectuer une mise à niveau vers la version 5.0.0 Service Pack 4 d’Adobe Experience Manager Guides.
...
# Instructions de mise à niveau vers la version 5.0.0 Service Pack 4 (avril 2026)

Cet article contient les instructions de mise à niveau et la matrice de compatibilité pour la version 5.0.0 du Service Pack 4 d’Adobe Experience Manager Guides.

Pour obtenir la liste des problèmes qui ont été résolus dans cette version, voir [Problèmes résolus dans le pack de services 4 d’ 5.0.0](../release-info/fixed-issues-5-0-0-sp4.md).

## Matrice de compatibilité

Cette section répertorie la matrice de compatibilité pour les applications logicielles prises en charge par Experience Manager Guides 5.0.0 Service Pack 4.
...
| Version | FMPS | FM |
| --- | --- | --- |
| 5.0.0 Service Pack 4 (UUID) | Pris en charge | 2022 ou version ultérieure |
...
## Mise à niveau vers la version 5.0.0 Service Pack 4 de Experience Manager Guides

Vous pouvez facilement mettre à niveau votre version actuelle de Guides vers la version 5.0.0 du Service Pack 4. Avant de procéder à la mise à niveau vers la version 5.0.0 Service Pack 4 de Experience Manager Guides, vous devez tenir compte des points suivants :

- Si vous utilisez la version 5.0.0 ou 5.0.x, vous pouvez directement effectuer la mise à niveau vers la version 5.0.0 du Service Pack 4.
