...
- Dans l’éditeur, la fonctionnalité de carte de téléchargement ne déclenche pas de notification pop-up lorsqu’elle est prête à être téléchargée. (14626)
- Dans l’éditeur, la fonction de téléchargement de carte ne parvient pas à télécharger une carte avec la ligne de base. (14622)
- Erreur DTD non valide dans le Experience Manager Guides. (14482)
- Le titre de l’onglet Éditeur est tronqué après un point(.) caractère. (14372)
...
- L’éditeur renvoie des erreurs d’application lors de l’ajout d’une nouvelle référence ou rubrique à l’aide d’un schéma spécialisé en mode **Disposition**. (14094)
...
- Le chargement de la collection **Favoris** dans l’éditeur échoue. (13495)
...
- Les fichiers Zip ne sont pas reconnus dans l’éditeur et vous ne pouvez pas les faire glisser et les déposer. (12709)
...
- Le paramètre de feuille de route persiste dans l’éditeur même si l’utilisateur ne l’a pas défini explicitement à partir des **Préférences utilisateur**. (11551)
- Le contenu auquel certains attributs sont appliqués n’est pas mis en surbrillance en mode **Création** ou **Aperçu**. (11063)
- Dans l’éditeur, la fenêtre **Références clés** s’ouvre lors de l’insertion de la balise `varname`. (10940)
...
- L’éditeur ne peut pas encapsuler un élément dans les éventuels éléments parents. (8791)
- L’éditeur est désinstallé après la réinstallation d’Adobe Experience Manager Guides version 4.3.1. (14519)
...
- Le préréglage **Site** ne permet pas de sélectionner un modèle en dehors de la hiérarchie `/content` dans l’éditeur. (14260)
...
- Option **ditaval** manquante dans les paramètres prédéfinis de sortie au niveau du profil de dossier créés via l’interface utilisateur de l’éditeur. (11903)
...
- Les fichiers **Filtre de ligne de base** ne fonctionnent pas avec le nom de fichier dans l’éditeur. (13486)
- Dans l&#39;éditeur, la ligne de base affiche le titre de la version précédente au lieu de la version sélectionnée du fichier DITA. (13444)
...
- Les libellés du fichier `labels.json` s’affichent dans un ordre aléatoire dans l’éditeur. (10508)
...
- Les problèmes de symétrie se produisent dans les panneaux de révision côte à côte des versions précédente et actuelle dans l’éditeur. (14156)
