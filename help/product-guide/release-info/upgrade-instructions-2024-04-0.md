...
Cet article décrit les instructions de mise à niveau et le tableau de compatibilité de la version 2024.04.0 de Adobe Experience Manager Guides as a Cloud Service.
...
Pour connaître la liste des problèmes résolus dans cette version, consultez [Correction de problèmes dans la version 2024.04.0](fixed-issues-2024-04-0.md).

## Matrice de compatibilité

Cette section répertorie le tableau de compatibilité des applications logicielles prises en charge par la version 2024.04.0 de Guides Experience Manager as a Cloud Service.
