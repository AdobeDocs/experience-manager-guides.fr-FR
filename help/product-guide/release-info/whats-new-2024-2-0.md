---
title: Notes de mise à jour | Nouveautés d’Adobe Experience Manager Guides version 2024.2.0
description: Découvrez les fonctionnalités nouvelles et améliorées de la version 2024.2.0 d’Adobe Experience Manager Guides as a Cloud Service.
...
Cet article présente les nouvelles fonctionnalités améliorées de la version 2024.2.0 d’Adobe Experience Manager Guides.
...
Vous pouvez désormais améliorer votre parcours de création avec les suggestions intelligentes, une nouvelle fonctionnalité basée sur l’IA dans l’éditeur web. Lorsque vous créez votre contenu, cette fonctionnalité intelligente fournit des suggestions en temps réel pour les références de contenu, ce qui améliore votre workflow, ajoute de la précision et assure une efficacité inégalée.
...
Vous pouvez également comparer le contenu actuel à du contenu similaire dans les autres rubriques. Vous pouvez ensuite facilement sélectionner des éléments de contenu de différentes rubriques et les ajouter en tant que références de contenu dans la rubrique active. L’ajout de références de contenu rend les mises à jour plus faciles à gérer, en particulier dans les projets de documentation plus volumineux. Par exemple, vous créez une brochure sur les dernières fonctionnalités de votre produit. Dans ce cas, vous pouvez rapidement ajouter les spécifications mises à jour en tant que références de contenu à partir des documents de fonction associés.

L’utilisation de cette fonctionnalité intelligente réduit l’effort manuel de recherche de contenu associé et vous permet de vous concentrer sur la création de nouveau contenu.  Cela permet également de maintenir la cohérence et de faciliter une meilleure collaboration entre les équipes.

En savoir plus sur les suggestions intelligentes optimisées par [IA pour créer du contenu](../user-guide/authoring-ai-based-smart-suggestions.md).
...
Pour en savoir plus sur la description de la fonctionnalité **Historique des versions**, consultez la section [Panneau de gauche](../user-guide/web-editor-features.md#id2051EA0M0HS).
...
## Possibilité de fractionner la liste actuelle et de commencer par un nouvel élément de liste au même niveau
...
Les améliorations apportées à la version 2024.2.0 de Native PDF sont les suivantes :

### Transmission de métadonnées de ressources à la sortie PDF

Experience Manager permet désormais de transmettre les propriétés de métadonnées des ressources du plan DITA à la sortie PDF.
À partir du paramètre prédéfini de sortie Native PDF, vous pouvez choisir les métadonnées que vous souhaitez transmettre au processus de publication PDF. Vous pouvez sélectionner les propriétés personnalisées et par défaut.  Les propriétés de métadonnées sélectionnées sont transmises au fichier PDF généré à l’aide de PDF natif.
