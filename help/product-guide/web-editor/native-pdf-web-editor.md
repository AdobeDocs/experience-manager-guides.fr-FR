...
Pour plus d’informations sur la génération d’un PDF à l’aide de la méthode DITA-OT, voir [Générer un PDF à l’aide de DITA-OT](/help/product-guide/user-guide/generate-output-pdf.md).
...
Pour plus d’informations sur la configuration de FMPS, voir [Générer une sortie à partir de documents de FrameMaker](/help/product-guide/user-guide/fm-output-generate.md).
