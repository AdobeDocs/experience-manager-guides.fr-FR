...
>[!TIP]
>
> Voir les sections *Configuration des profils DITA-OT* et *Utilisation de DITA-OT* dans le guide Bonnes pratiques pour connaître les bonnes pratiques relatives à l’utilisation des modules externes DITA-OT personnalisés.
...
1. Téléchargez à nouveau le fichier ZIP mis à jour dans le référentiel AEM.
   ...
   >[!NOTE]
   >
   > Il est recommandé de ne pas remplacer le package DITA-OT par défaut. Vous devez charger votre package DITA-OT personnalisé contenant votre dossier /var/dxml/dita\_resources/dita-ot . Vous pouvez également le faire à l’aide du pipeline Cloud Manager. Pour plus d’informations, voir [Déploiement sur AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/deploying/overview.html?lang=fr) dans AEM documentation.
...
Effectuez les étapes suivantes pour créer un nouveau profil et le configurer afin d’utiliser des DTD et des XSD spécialisés dans votre AEM Guides :
