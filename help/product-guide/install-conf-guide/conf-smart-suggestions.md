...
7. [Configuration des suggestions intelligentes dans le profil de dossier](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring)
...
Pour plus d’informations, voir [Configuration des suggestions intelligentes dans le profil de dossier](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring).
