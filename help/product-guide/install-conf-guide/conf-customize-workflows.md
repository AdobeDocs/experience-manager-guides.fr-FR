...
## Personnaliser le workflow Ressource de mise à jour (uniquement pour On-Premise)
...
## Configuration du workflow XML de post-traitement (uniquement pour On-Premise)
