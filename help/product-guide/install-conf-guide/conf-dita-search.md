...
Les onglets suivants fournissent des instructions pour ajouter des éléments ou attributs DITA personnalisés dans le fichier de sérialisation de recherche en fonction de votre configuration Experience Manager Guides : Cloud Service ou On-Premise.
...
Les onglets suivants fournissent des instructions pour activer l’option d’extraction des métadonnées dans le `configMgr` en fonction de votre configuration Experience Manager Guides : Cloud Service ou On-Premise.
...
1. Ouvrez la page de configuration de la console web Adobe Experience Manager . L’URL par défaut pour accéder à la page de configuration est :
   ...
   `http://<server name\>:<port\>/system/console/configMgr`s
...
Les onglets suivants fournissent des instructions pour exclure le dossier de traduction temporaire de la recherche en fonction de votre configuration Experience Manager Guides : Cloud Service ou On-Premise.
