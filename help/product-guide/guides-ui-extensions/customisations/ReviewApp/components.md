---
title: Composants
description: Vérifier les composants d’application
role: User, Admin
...
![Capture d’écran du panneau de révision en ligne](./imgs/inline_review.png)
...
![Capture d’écran de commentaires de révision](./imgs/review_comment.png)

Commentaire de révision côté éditeur xml :
![Capture d’écran de commentaires de révision](./imgs/review_comment_xmleditor.png)

- Review Comment Reply: `id: comment_reply`
   - Le widget pour chaque réponse de commentaire de révision.
     ![Capture d’écran de réponse au commentaire de révision](./imgs/reply.png)
...
- Nouveau commentaire de révision Réponse : `id: comment_new_reply`
   - Le widget pour la nouvelle réponse de commentaire de révision.
     ![Nouvelle capture d’écran de réponse au commentaire de révision](./imgs/new_reply.png)
