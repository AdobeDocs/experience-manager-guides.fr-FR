...
> - Le type de référence Web Link insère toujours scope=`external` par défaut et ajoute l&#39;URL en l&#39;état, sans modification. Ce comportement s’applique de manière cohérente aux chemins d’accès relatifs et absolus, sur tous les types d’URL pris en charge, y compris HTTP/S et FTP/S.
