...
La barre d’onglets se trouve en haut de l’interface de l’éditeur et permet d’accéder aux différentes fonctionnalités au niveau du fichier.
...
>[!NOTE]
>
> En tant qu’administrateur, vous pouvez également choisir d’afficher la liste des fichiers par nom de fichier dans les onglets. Sélectionnez l’option **Nom de fichier** dans la section **Configuration de l’affichage des fichiers de l’éditeur** sous [Préférences utilisateur](./intro-home-page.md#user-preferences).
