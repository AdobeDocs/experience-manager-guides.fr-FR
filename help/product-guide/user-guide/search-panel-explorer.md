---
title: Panneau de recherche dans l’interface de l’éditeur
...
Pour accéder au panneau de recherche, procédez comme suit :
...
- Vue centralisée de tous les résultats de recherche pour une référence facile.
- Fonctionnalité de glisser-déposer pour insérer des références directement dans votre rubrique ou carte actuelle.
- Des options flexibles pour modifier ou affiner les recherches sans quitter l’éditeur

## Rechercher dans le panneau de l’explorateur

Lorsque vous travaillez dans l’interface de l’éditeur, vous pouvez filtrer l’ensemble de fichiers afin d’afficher un sous-ensemble des fichiers pertinents dont vous avez besoin. Effectuez les étapes suivantes pour rechercher des fichiers dans l’Explorateur :

1. Sélectionnez l’icône **Rechercher** dans le coin supérieur droit du panneau **Explorateur** ou l’icône **Rechercher** présente en bas à gauche de la **zone de modification de contenu**. La boîte de dialogue **Rechercher un référentiel** s’ouvre. Elle offre la même expérience de recherche et de filtrage que l’interface de référentiel de la page d’accueil.
...
Lorsque vous effectuez une recherche et appliquez des filtres dans l’interface du référentiel sur la page d’accueil, en sélectionnant **Afficher dans le panneau de recherche** vous redirige vers l’interface de l’éditeur. Tous les résultats de la recherche seront mis en miroir dans le panneau de recherche au bas de l’interface de l’éditeur.
