...
D&#39;une manière générale, le processus de conversion nécessite que vous [Préparez les fichiers InDesign pour la conversion](appendix.md#id195DBF0045Z) et [Préparez le fichier de mappage pour la migration d&#39;InDesign vers DITA](appendix.md#id194AF0003HT) vous devez suivre la procédure donnée d&#39;exécution du processus de conversion.
...
>[!NOTE]
>
> Pour plus d&#39;informations sur `stmap.adobeidml.xml` structure et la personnalisation du fichier, reportez-vous à la section [Préparer le fichier de mappage pour la migration d&#39;InDesign vers DITA](appendix.md#id194AF0003HT) de l&#39;*Annexe*.
