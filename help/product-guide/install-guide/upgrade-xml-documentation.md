...
>[!TIP]
>
> Il est recommandé d’installer le pack de services 3 d’ 4.6.0 sur la version 4.6.0 ou 4.6.0 du pack de services 1. Le processus de mise à niveau vers le pack de services 3 version 4.6.0 suit les mêmes étapes que pour la version 4.6.0.
