...
>[!TIP]
>
> La mise à niveau vers la version 5.0.0 du pack de services 3 dépend de la version actuelle de Experience Manager Guides. Si vous utilisez la version 5.0.0 Service Pack 2, 5.0.0 Service Pack 1 ou 5.0.0, vous pouvez directement mettre à niveau vers la version 5.0.0 Service Pack 3.
...
>[!NOTE]
>
>Si vous effectuez une mise à niveau vers le pack de services 3 d’ 5.1.0, vous devez utiliser la version 5.1.0 ou 5.1.x de Experience Manager Guides.
